...
<head>
    <meta charset="UTF-8">
    <title>Login Admin Poliklinik</title>
...
<body>
    <div class="row" style="margin-top: 7%;">
        <div class="container">
            ...
            <h3 class="center">Login Admin <span class="orange-text">Poliklinik</span></h3>
            <div class="card z-depth-2" style="height:280px;">
                <div class="card-content">
                    ...
                    <?php  
                        ...
                        if (@$_POST['login']) {
                            $select = $db->prepare("SELECT * FROM login WHERE username = ? AND password = ?");
