...
<head>
  <meta charset="UTF-8">
  <title>Sistem Inventory &raquo; NEGAKOM</title>
  ...
  <!-- Dropdown Structure -->
    ...
    <nav>
      <div class="nav-wrapper light-blue darken-3">
        <a href="?page=" class="brand-logo" style="margin-left:10px;">Sistem Inventory Negakom</a>
        <ul class="right hide-on-med-and-down ">
          ...
          <!-- Dropdown Trigger -->
          <li class="red waves-effect waves-light"><a href="logout.php"><i class="material-icons left">power_settings_new</i>Logout</a></li>
        </ul>
      </div>
    </nav>
      ...
      <div class="section" style="margin-left:50px;margin-right:50px;">
        <?php 
          ...
          if ($pages == '') {
            ...
            } else if ($action == 'tambahstok') {
              include 'pages/tambahstok.php';
            }
