<h5 class="blue-text margin-left:10px;">
    <blockquote><strong>Data Barang Keluar</strong><div class="right "><a href="?page=barangkeluar&action=tambah" class="btn-floating btn-large blue waves-effect waves-light" style="margin-right:0px;"><i class="material-icons">add</i></a></div></blockquote>
  </button>
</h5>
<hr class="orange">
  <?php  
...
<table class="striped">
    ...
    <?php  
        ...
        <tr>
            ...
            <td class="center">
                <a onclick="return confirm('Yakin akan Menghapus data.?');" class="left btn-floating red modal-trigger" href="?page=barangkeluar&action=hapus&id=<?php echo $data->id_keluar; ?>"><i class="material-icons">delete</i></a>
            </td>
        </tr>
        <?php
        }
