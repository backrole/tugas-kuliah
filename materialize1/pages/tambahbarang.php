<h5 class="blue-text margin-left:10px;">
    <blockquote><strong>Tambah Data Barang</strong>
            <a href="?page=barang"><button class="btn-floating waves-effect waves-light right red" style="margin-right:10px;"><i class="material-icons right">fast_rewind</i></button></a>
    </blockquote>
  </button>
</h5>
<?php  
...
<div class="row">
    <form class="col s12" method="post">
      <div class="row">
        ...
        <div class="input-field col s3">
          <input id="kode" required readonly="readonly" type="text" name="kode" value="PRT<?php echo $new_code; ?>" class="validate">
      ...
      <div class="row">
        <blockquote style="margin-left:10px;">
            <button class="btn waves-effect waves-light blue" value="simpan" name="simpan">Simpan<i class="material-icons right">save</i></button>&nbsp;&nbsp;&nbsp;
            <input type="reset" name="reset" value="loop" class="btn waves-effect waves-light center s1 material-icons green small">&nbsp;&nbsp;&nbsp;
        </blockquote>
      </div>
      <?php  
  ...
  <?php  
    ...
    try {
        if (@$_POST['simpan']) {
            ...
            if ($input->rowCount()>0) {
              $insert = $db->prepare("INSERT INTO data_persediaan (id_masuk, nama_barang) VALUES (?,?)");
              $array = array($id_masuk, $nama);
