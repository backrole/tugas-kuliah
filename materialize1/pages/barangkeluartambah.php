<h5 class="blue-text margin-left:10px;">
  <blockquote><strong>Transaksi Barang Keluar</strong>
    <a href="?page=barangkeluar"><button class="btn-floating waves-effect waves-light right red" style="margin-right:10px;"><i class="material-icons right">fast_rewind</i></button></a>
    </blockquote>
</button>
</h5>
<?php  
...
<div class="row">
  ...
  <div class="row">
    <blockquote style="margin-left:10px;">
      <button class="btn waves-effect waves-light" value="simpan" name="simpan">Simpan<i class="material-icons right">save</i></button>&nbsp;&nbsp;&nbsp;
