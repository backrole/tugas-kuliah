<h3 class="text-muted">Buku <i class="fa fa-book"></i></h3> 
<hr>
<a class="btn btn-primary" data-toggle="modal" href='#tambah'><i class="fa fa-plus-circle"></i> Tambah Data Buku</a>
<a class="btn btn-success" href=".?page=buku&action=cetak">Cetak Laporan <i class="fa fa-print"></i></a>
<br>
	...
	<tbody>
		...
		while ($showed = $show->fetch(PDO::FETCH_LAZY)) {
			...
			<tr>
				...
				<td>
					<a href=".?page=buku&action=edit&id=<?php echo $showed->id_buku; ?>" class="btn-sm btn-warning"><i class="fa fa-edit"></i></a>
					<a class="btn-sm btn-danger" data-toggle="modal" href='.?page=buku&action=hapus&id=<?php echo $showed->id_buku; ?>'><i class="fa fa-trash"></i></a>
				</td>
			</tr>
			<?php		
		}
