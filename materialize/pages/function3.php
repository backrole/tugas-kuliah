...
function paging ($tabel, $dataPerPage, $noPage, $link) {
    ...
    if ($noPage > 1) 
        echo "<a href='" . $link . "hal=" . ($noPage - 1) . "'>";?><li><i class="mdi-navigation-chevron-left blue-text"></i></li></a>
        <?php
    ...
    if ($noPage<$jumPage){
    ?>
        <a href='<?php echo $link; ?>hal=<?php echo $noPage + 1; ?>'><li><i class="mdi-navigation-chevron-right"></i></li></a>
    <?php
    }
}
?>
