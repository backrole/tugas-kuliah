<h5 class="blue-text margin-left:10px;">
    <blockquote><strong>Data Barang Masuk</strong><div class="right "><a href="?page=barangmasuk&action=tambah" class="btn-floating btn-large blue waves-effect waves-light" style="margin-right:0px;"><i class="mdi-content-add"></i></a></div></blockquote>
  </button>
</h5>
<hr class="orange">
  <?php  
...
<table class="striped">
    ...
    <?php  
        ...
        <tr>
            ...
            <td class="left">
                <a onclick="return confirm('Yakin akan Menghapus data.?');" class="btn-floating red modal-trigger" href="?page=barangmasuk&action=hapus&kd=<?php echo $data->id_masuk; ?>"><i class="mdi-action-delete"></i></a>
            </td>
        </tr>
        <?php
        }
