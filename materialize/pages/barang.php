<h5 class="blue-text margin-left:10px;">
    <blockquote><strong>Data Barang</strong><div class="right "><a href="?page=barang&action=tambah" class="btn-floating btn-large blue waves-effect waves-light" style="margin-right:0px;"><i class="mdi-content-add"></i></a></div></blockquote>
  </button>
</h5>
<hr class="orange">
  <?php  
...
<table class="striped">
    ...
    <?php  
        ...
        <tr>
            ...
            <td class="left">
                <a href="?page=barang&action=edit&kd=<?php echo $data->kode_barang; ?>" class="btn-floating btn-small waves-effect waves-light orange"><i class="mdi-editor-mode-edit"></i></a>
                    &nbsp;
                <a onclick="return confirm('Yakin akan Menghapus data.?');" class="btn-floating red modal-trigger" href="?page=barang&action=hapus&kd=<?php echo $data->kode_barang; ?>"><i class="mdi-action-delete"></i></a>
            </td>
        </tr>
        <?php
        }
